...
#
# The workflow drops fresh copies of docker-compose.prod.yml, Caddyfile
# and this script into /opt/tonalys before running it, and passes the
# commit SHA as IMAGE_TAG so each deploy pins an immutable image.
#
