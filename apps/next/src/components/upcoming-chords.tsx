  ...
  return (
    <div className="flex w-full flex-col gap-1">
      <div className="flex items-center gap-1 text-xs font-medium text-muted-foreground">
        Upcoming
        <Popover>
          <PopoverTrigger type="button" aria-label="About the chord bars">
      ...
      <ul aria-label="Upcoming" className="flex w-full flex-col items-start gap-1">
        {chords.map((chord) => (
          <li
            key={chord.id}
          ...
          >
            <span className="whitespace-nowrap">{chord.label}</span>
